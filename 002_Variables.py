...
round_closest=round(div_float)                      # Round the float number to the whole number(increment to the next closest whole number)
round_2_decimal_places=round(div_float,2)           # Print the float number until n decimal places. e.g. in this case n=2
